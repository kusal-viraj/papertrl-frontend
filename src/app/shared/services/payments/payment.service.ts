...
export class PaymentService {
   ...
   */
  uploadPaymentFileList(file: File) {
    const formData = new FormData();
    formData.append('file', file);
    return this.http.post(ApiEndPoint.API_URL + '/payment_service/sec_upload_payment_request_list_csv',
      formData, {observe: 'response', withCredentials: true});
  }


  getUploadedPercentage(fileId) {
    return this.http.get(ApiEndPoint.API_URL + '/payment_service/sec_get_payment_request_upload_percentage',
      {observe: 'response', withCredentials: true, params: {uuid: fileId}});
  }

  getUploadedFileIssue(fileId) {
    return this.http.get(ApiEndPoint.API_URL + '/payment_service/sec_get_payment_request_upload_issues',
      {observe: 'response', withCredentials: true, params: {uuid: fileId}});
  }

  /**
   * This service use for download payment file upload template
   */
  downloadPaymentFileListUploadTemplate() {
    return this.http
      .get(ApiEndPoint.API_URL + '/payment_service/sec_download_payment_request_upload_template',
        {
          responseType: 'blob',
  ...
  getSystemPackageInfo() {
    return this.http.get(ApiEndPoint.API_URL + '/integration/sec_tp_system_config_details',
      {observe: 'response', withCredentials: true});
  }
   ...
   */
  getFundingAccounts() {
    return this.http.get(ApiEndPoint.API_URL + '/payment_service/sec_get_funding_account_list',
      {observe: 'response', withCredentials: true});
  }
  ...
  createProcessPayment(fundingAccountId, payment) {
    return this.http.post<any[]>(ApiEndPoint.API_URL + '/payment_service/sec_payment_create_for_request',
      payment, {observe: 'response', params: {fundingAccountId}});
  }
  ...
  getSummaryForProcessPayment(fundingAccountId, payment) {
    return this.http.post<any[]>(ApiEndPoint.API_URL + '/payment_service/sec_get_grouped_request_summery',
      payment, {observe: 'response', params: {fundingAccountId}});
  }

  getProcessPaymentRequestList(searchFilterDto: TableSearchFilterDataDto, fundingAccountId, isFileUpload) {
    return this.http.post(ApiEndPoint.API_URL + '/payment_service/sec_get_process_payment_request_list',
      searchFilterDto, {observe: 'response', withCredentials: true, params: {fundingAccountId, isFileUpload}});
  }
  ...
  getPaymentMailOption() {
    return this.http.get(ApiEndPoint.API_URL + '/payment_service/sec_get_payment_mail_option',
      {observe: 'response'});
  }
