...
@Component({
  selector: 'app-add-new-approval-group',
  templateUrl: './add-new-approval-group.component.html',
  styleUrls: ['./add-new-approval-group.component.scss']
})
export class AddNewApprovalGroupComponent implements OnInit {
