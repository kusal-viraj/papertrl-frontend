...
describe('Create E bill Component', () => {
  ...
  beforeEach(async () => {
    let billSubmitServiceSpy = jasmine.createSpyObj('BillSubmitService', ['getPoCeiling',
      'getDueDate', 'editBill'])
    let billsServiceSpy = jasmine.createSpyObj('BillsService', ['getDefaultPoDrawerState',
    ...
    let billApprovalsServiceSpy = jasmine.createSpyObj('BillApprovalsService', ['getItemName'])
