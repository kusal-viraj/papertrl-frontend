...
import {VendorAchRegisterComponent} from './modules/auth/vendor-ach-register/vendor-ach-register.component';
...
const routes: Routes = [
  ...
  {path: 'payment-details', component: VendorAchRegisterComponent},
  {
