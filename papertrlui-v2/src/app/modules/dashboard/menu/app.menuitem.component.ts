...
<!--        <li (click)="itemClick($event)"  [routerLink]="item.routerLink" routerLinkActive="active-route"  [class]="item.badgeClass">-->
<!--          <i [ngClass]="item.icon" class="layout-menuitem-root-text"></i>-->
