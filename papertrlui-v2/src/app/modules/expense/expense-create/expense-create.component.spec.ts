...
describe('ExpenseCreateComponent', () => {
  ...
  beforeEach(async () => {
    ...
    const billsServiceSpy = jasmine.createSpyObj('BillsService', ['getVendors', 'getProjectTask']);
    const expenseServiceSpy = jasmine.createSpyObj('ExpenseService', ['searchMerchants',
    ...
    TestBed.configureTestingModule({
      ...
      imports: [ReactiveFormsModule, HttpClientTestingModule, FormsModule, CommonModule,
  ...
  it('check report name field validity with empty', () => {
    const vendorId = component.createExpenseForm.controls.reportName;
