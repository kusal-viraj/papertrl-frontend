...
@NgModule({
  declarations: [AuditTrialComponent, AddVendorComponent, TableBillNoOverlayComponent,
    ...
    SkipTabviewDirective, CountryPanelOpenDirective, MultiselectFocusDirective, AdditionalFieldLineItemsComponent,
    AdditionalFieldHeaderItemsComponent, NoNegativeValuesDirective, LoaderComponent, TreeCheckboxComponent, AccessDeniedContainer],
