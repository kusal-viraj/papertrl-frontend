...
export class PaymentService {
  ...
  getSummaryForProcessPayment(payment) {
    return this.http.post<any[]>(ApiEndPoint.API_URL + '/payment_service/sec_get_grouped_request_summery',
      payment, {observe: 'response'});
  }

  getProcessPaymentRequestList(searchFilterDto: TableSearchFilterDataDto, isFileUpload) {
    return this.http.post(ApiEndPoint.API_URL + '/payment_service/sec_get_process_payment_request_list',
      searchFilterDto, {observe: 'response', withCredentials: true, params: {isFileUpload}});
  }
